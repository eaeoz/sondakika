...
2. [Windows Masaüstü Uygulaması (v2.0.4 GUI)](#windows-masaüstü-uygulaması-v204-gui)
...
3. [GUI Klavye Kısayolları](#gui-klavye-kısayolları)
4. [Eski CLI Kullanımı (v1.x)](#eski-cli-kullanımı-v1x)
...
5. [Kaynaktan Derleme](#kaynaktan-derleme)
